    ...
    <div className="min-h-screen bg-bg flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm relative">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-accent/10 border border-accent/30 rounded-2xl mb-4 accent-glow">
          ...
          <p className="text-muted text-sm mt-1">Floor cleaning progress tracking</p>
        </div>
